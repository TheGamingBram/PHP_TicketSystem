...
CREATE TABLE IF NOT EXISTS `ticket` (
  ...
  `Ticket_Subject` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Ticket_Priority` int NOT NULL,
  `Ticket_Message` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Ticket_Attachments` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Saved using the serialize() command',
